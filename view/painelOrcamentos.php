            ...
            <div class="accordion-item" id="orcamento-item-<?= $orcamento['id'] ?>">
                <h2 class="accordion-header" id="heading-<?= $orcamento['id'] ?>">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapse-<?= $orcamento['id'] ?>">
                        <div class="d-flex justify-content-between flex-wrap w-100 pe-3">
                            ...
                            <span class="me-3"><strong>Data:</strong>
                                <?= date('d/m/Y H:i', strtotime($orcamento['data_criacao'])) ?></span>
                            <span class="text-success fw-bold">R$
                                <?= number_format($orcamento['valor_total'], 2, ',', '.') ?></span>
                        </div>
                    </button>
                </h2>
                <div id="collapse-<?= $orcamento['id'] ?>" class="accordion-collapse collapse"
                    data-bs-parent="#accordionOrcamentos">
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <button class="btn btn-outline-danger btn-sm mt-3 delete-btn" data-id="<?= $orcamento['id'] ?>"
